...
@section('content')
    <section class="bg-[#0006] p-4 outline rounded-md w-80 flex flex-col  justify-center items-center">
        <img src="{{asset('images/logo.png')}}" class="size-64 object-cover">
        <p class="text-justify">
            Larapets connecting shelters with loving homes.
            Browse, match, and adopt pets easily. Find your perfect
            furry friend today!
        </p>
